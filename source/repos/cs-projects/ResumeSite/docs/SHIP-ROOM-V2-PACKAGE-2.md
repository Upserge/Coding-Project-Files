...
- [ ] Game HUD, upgrade modal, toasts still legible
...
- [ ] `shaderPreset: 'aurora'` works without studio files loaded path issues
- [ ] Classic path bit-identical when `shaderV2: false`
- [ ] Hero destroys cleanly on route change
